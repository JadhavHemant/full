...
const ChartOfAccountsPage = () => {
  ...
  const fetchData = useCallback(async () => {
    setLoading(true);
    try {
      const response = await axiosInstance.get("/accounts/chart");
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (selectedItem) {
        ...
        await axiosInstance.post("/accounts/chart", formData);
  ...
  return (
    <div className="p-6">
      <TitleBar title="Chart of Accounts" />
      <Toaster />
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg shadow-xl w-full max-w-2xl max-h-[90vh] flex flex-col">
            ...
            <div className="flex justify-between items-center p-6 border-b">
              <h2 className="text-2xl font-bold text-gray-900">{selectedItem ? 'Edit' : 'Add'} Chart of Accounts</h2>
              <button
